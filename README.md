 ...
 * [LeKiwi](https://github.com/SIGRobotics-UIUC/LeKiwi) - small omnidirectional robot with an [SO-ARM100](https://github.com/TheRobotStudio/SO-ARM100) attached to it. Licence: Apache 2.0.

### Robot Arms
 * [Dexter](https://github.com/HaddingtonDynamics/Dexter) - Open Source industrial robotics arm project. For more information please see [Haddington Dynamics webpage](http://hdrobotic.com/open-source). Licence: GPLv3.
 ...
 * [UrbanLoco](https://github.com/weisongwen/UrbanLoco) - Another robotic car dataset providing sensor information as a ROS bag. Licence: CC BY-NC-SA 4.0.
 ...
 * [L2D Dataset](https://huggingface.co/datasets/yaak-ai/L2D) - A huge dataset captured by driving schools in Germany. Article desribing this work in more detail can be found [here](https://huggingface.co/blog/lerobot-goes-to-driving-school).
 ...
 * [Raisim](https://raisim.com/) - A physics for rigid-body dynamics simulation. Licence: Free for non-commercial use.
 ...
 * [RAI](https://github.com/RobotecAI/rai) - An agentic framework for robotics that enables the development and deployment of Embodied AI features. It integrates generative AI, multi-agent systems, voice interaction, and ROS 2, allowing robots to perceive, reason, and act autonomously. Licence: Apache 2.0.
 ...
 * [BehaviourTree.CPP](https://github.com/BehaviorTree/BehaviorTree.CPP) - Behavior Trees Library in C++. Licence: MIT.
 ...
 * [A Machine Learning Course with Python](https://github.com/instillai/machine-learning-course/tree/master) - Freely available Machine Learning course using Python developed by [Machine Learning Mindset](https://www.machinelearningmindset.com/blog/).
 ...
 * [How to Start a Robot Revolution](https://www.youtube.com/watch?v=ErHAhRiUaY0) - a Red Hat documentary on ROS.
